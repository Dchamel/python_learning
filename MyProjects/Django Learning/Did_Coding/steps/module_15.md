...
1) Templates - We need to create new html files for each of the main e-commerce views that we have created. Go ahead and
   create a new directory in /templates and call it ecommerce.
