...
In this module we will be building a manager that will handle the flow of data between the frontend, e-commerce app
and [Stripes API](https://stripe.com/docs/api?lang=python).

Let's get started.

1) Utilities - Go ahead and create a new file in /ecommerce and call it utils.py. Use the following code. Don't worry -
   I'll walk you through what we're doing here.
